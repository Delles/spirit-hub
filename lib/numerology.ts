...
import { ValidationError, validateDate, validateNumerologyNumber, validateName } from "@/lib/utils";
...
export function calculateCompatibility(num1: number, num2: number): number {
  ...
  const isMaster1 = num1 === 11 || num1 === 22 || num1 === 33;
  const isMaster2 = num2 === 11 || num2 === 22 || num2 === 33;
